...
```
cd existing_repo
git remote add origin https://gitlab.com/afx83635/mesenger-full.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/afx83635/mesenger-full/-/settings/integrations)
